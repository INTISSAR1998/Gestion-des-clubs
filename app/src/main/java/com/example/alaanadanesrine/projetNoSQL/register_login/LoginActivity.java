package com.example.alaanadanesrine.projetNoSQL.register_login;
...
import com.example.alaanadanesrine.projetNoSQL.MainActivity2;
import com.example.alaanadanesrine.projetNoSQL.R;
import com.example.alaanadanesrine.projetNoSQL.SessionManager;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void verifSQL(){
        if (!inputValidation.isInputEditTextFilled(textInputEditTextEmail, textInputLayoutEmail, getString(R.string.error_message_email))) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, "http://"+str_ip+"/min/login.php", new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    try {
                        ...
                        if(succes.equals("1")){
                            ...
                            emptyInputEditText();
                                Intent accountsIntent = new Intent(activity, MainActivity2.class);
                                accountsIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
