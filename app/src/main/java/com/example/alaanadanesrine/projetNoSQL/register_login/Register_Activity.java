...
public class Register_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void postData() {
        ...
        if (!inputValidation.isInputEditTextFilled(textInputEditTextEmail, textInputLayoutEmail, "Empty E-Mail")) {
            return;
        }
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "http://"+str_ip+"/min/signup.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    if (succes.equals("2")){
                        Snackbar.make(nestedScrollView, "Email Already Exist", Snackbar.LENGTH_LONG).show();
                    }
                    if (succes.equals("1")){
...

        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("login",textInputEditTextName.getText().toString().trim());
